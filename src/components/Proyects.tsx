  ...
  return (
    <>
      <section id="portfolio" className="pt-20 flex flex-col">
        ...
        {/* Moviles */}
        <div className="flex self-center gap-5 md:hidden">
          <div className="embla w-50 order-2">
...
export function Card(props: CardProps) {
  return (
    <div
      className={`${props.class} flex flex-col border-neutral-content/80 border-1 w-50 rounded-xl shadow-[-5px_5px_5px_rgba(0,0,0,0.25)]`}
    >
